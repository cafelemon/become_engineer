...
const lessonRoot = `${base}/learning-paths/llm-agent/model-use`;
const slugs = [
  "01-model-boundary-messages-offline-adapter",
  "02-prompt-roles-version-parameters-context-budget",
  "03-json-schema-semantic-validation-missing-information",
  "04-error-taxonomy-deadline-backoff-bounded-retry",
  "05-stream-delta-order-finish-cancel",
  "06-provider-config-secrets-redaction-delivery",
];
const modes = [
