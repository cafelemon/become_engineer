...
const lessonRoot = `${base}/learning-paths/llm-agent/rag-eval`;
const slugs = [
  "01-corpus-document-source-reproducible-index",
  "02-inverted-index-bm25-top-k-stable-ranking",
  "03-chunk-overlap-source-coordinates-citation",
  "04-embedding-cosine-rrf-hybrid-retrieval",
  "05-grounded-claim-citation-abstention",
  "06-fixed-eval-retrieval-citation-regression-gates",
];
const modes = [
