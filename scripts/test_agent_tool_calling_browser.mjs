...
const lessonRoot = `${base}/learning-paths/llm-agent/tool-calling-workflow`;
const slugs = [
  "01-tool-definition-registry-candidate-call-strict-arguments",
  "02-business-validation-authorization-read-only-execution",
  "03-multiple-calls-call-id-correlation-partial-failure",
  "04-controlled-side-effects-confirmation-idempotency",
  "05-bounded-tool-loop-state-budgets-termination",
  "06-fixed-adversarial-evaluation-regression-delivery",
];
const modes = [
...
for (const mode of modes) {
  ...
  for (const slug of slugs) {
    ...
    const audit = await page.evaluate(() => ({
      ...
      profiles: ["零基础兴趣", "有基础兴趣", "零基础求职", "有基础求职"]
