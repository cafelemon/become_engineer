...
需要 MCU、嵌入式 Linux、工业控制或端侧 AI 能力的学习者，可以在满足 C++、系统、并发、网络和相应 AI 前置后进入[设备系统与边缘智能](../learning-paths/device-edge-systems/README.md)。MCU/RTOS、嵌入式 Linux/BSP 和工业控制并列；边缘智能要求 AI 基础与至少一条设备平台能力汇合。该领域采用仿真入门、真机毕业，不需要时可以完整跳过，不影响 AI 推荐深化、强化学习、其他 AI 选修或 LLM/Agent。
