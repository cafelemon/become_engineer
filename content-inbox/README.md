...
素材队列不决定学习顺序。所有取材和加工都必须服务于[面向小白的统一学习路线](../learning-paths/beginner-roadmap.md)，不能因为某类素材数量多就提前建设后置阶段。
...
- [按需取用的外部来源](external-source-catalog.md)
...
对于大型公开站点或官方文档，先建立目录级来源地图。只有路线章节或项目里程碑提出明确需求时，才拉取最小必要内容。

## 项目推动原则

在满足阶段前置条件后，理论和实践可以并行推进，但不强迫所有内容都做成独立项目。
