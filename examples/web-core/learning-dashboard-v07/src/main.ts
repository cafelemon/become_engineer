...
import { renderReplay, renderSessions, renderSummary, type DashboardRefs } from "./render.js";
...
const replayButton = requiredElement<HTMLButtonElement>("[data-replay-write]");
let activeLearnerId = "xiaoma";
let nextAfterId: number | null = null;

async function loadFirstPage(learnerId: string): Promise<void> {
