import { isLearningSummary, isStudySessionPage, isStudySessionWriteResult, summaryToRecord } from "./contracts.js";
const API_ROOT = "/api";
...
export async function createStudySession(learnerId, idempotencyKey, fetchImpl = fetch) {
    let response;
    try {
