...
- [工程基础](learning-paths/engineering-foundation/README.md)：Git、命令行、调试、测试、工程习惯、学习方法。
- [编程语言](learning-paths/programming-languages/README.md)：Python、C++、JavaScript/TypeScript。
- [Web 全栈](learning-paths/web-fullstack/README.md)：前端、后端、数据库、API、部署。
- [CS 核心](learning-paths/cs-core/README.md)：数据结构、算法、操作系统、网络、系统设计。
- [AI 基础](learning-paths/ai-foundation/README.md)：机器学习、深度学习、强化学习。
