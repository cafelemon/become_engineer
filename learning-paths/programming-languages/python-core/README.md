...
从[类型提示、接口与静态检查认知](01-type-hints-interfaces-static-checking.md)开始，按表格顺序学习到[容器协议、迭代器与生成器](03-iterables-iterators-generators.md)。完成后进入C++对象、引用、指针、生命周期与RAII，继续建立双语言的对象与资源能力对照。
