...
export type SessionField = "hours" | "note";
export type FieldErrors = Partial<Record<SessionField, string>>;
...
export type FormState =
  ...
  | { kind: "field-error"; message: string; errors: FieldErrors }
  | { kind: "network-error" | "server-error" | "contract-error"; message: string };
